            ...
            wandb.log(
                {
                    ...
                    "train/loss_recon": train_metrics["recon"],
                    "train/loss_recon_text": train_metrics["recon_text"],
                    "train/loss_recon_image": train_metrics["recon_image"],
                    "train/loss_concept": train_metrics["concept"],
                    "train/loss_intervene": train_metrics["intervene"],
                    "train/loss_adversarial": train_metrics.get("adversarial", 0.0),
                    "val/loss_total": val_metrics["loss"],
                    "val/loss_recon": val_metrics["recon"],
                    "val/loss_recon_text": val_metrics["recon_text"],
                    "val/loss_recon_image": val_metrics["recon_image"],
                    "val/loss_concept": val_metrics["concept"],
                    "val/loss_intervene": val_metrics["intervene"],
